...
import fr.lumin0u.survivor.utils.McSound;
...
{
	LITTLE_KNIFE(LittleKnife.class, RepeatingType.NONE, "Couteau", Material.IRON_SHOVEL, 100, 1, 5, new McSound(), 100, false, -1, 20, Arrays.asList("dmg"), Arrays.asList(4.2D)),
	BUCHER_KNIFE(BucherKnife.class, RepeatingType.NONE, "Couteau de Boucher", Material.BRICK, 30, 1, 20, new McSound(), 300, true, -1, 40, Arrays.asList("dmg"), Arrays.asList(18.9D)),
	...
	MCS(MCS.class, RepeatingType.SEMIAUTOMATIC, "MCS", Material.STONE_PICKAXE, 80, 4, 84, new McSound("guns.olympia", 80), 1, true, -1, 30, Arrays.asList("dmg", "range", "accuracy", "shots"), Arrays.asList(6.9D, 20.0D, 0.8D, 5)),
	...
	AIRSTRIKE(AirStrike.class, RepeatingType.SEMIAUTOMATIC, "Airstrike", Material.REDSTONE, 0, 1, 1, new McSound("random.click", 10), 1, false, 7, 1, Arrays.asList(), Arrays.asList()),
	MEDIC_KIT(MedicKit.class, RepeatingType.SEMIAUTOMATIC, "Medic Kit", Material.PAPER, 0, 1, 53, new McSound("guns.medic", 15), 1, false, 6, 23, Arrays.asList(), Arrays.asList()),
	LANCEPATATE(LancePatate.class, RepeatingType.SEMIAUTOMATIC, "Lance Patate", Material.STONE_SHOVEL, 0, 5, 64, new McSound("guns.m79", 20), 1, false, 8, 15, Arrays.asList(), Arrays.asList()),
	...
	GRENADE(Grenade.class, RepeatingType.NONE, "Grenade", Material.CLAY_BALL, 0, 3, 64, new McSound(), 1, false, 6, 15, Arrays.asList(), Arrays.asList()),
	GRENADEFRAG(GrenadeFrag.class, RepeatingType.NONE, "Grenade Frag", Material.SLIME_BALL, 0, 2, 64, new McSound(), 1, false, 6, 15, Arrays.asList(), Arrays.asList()),
	GRENADEFLAME(GrenadeFlame.class, RepeatingType.NONE, "Grenade Incendiaire", Material.MAGMA_CREAM, 0, 3, 64, new McSound(), 1, false, 6, 15, Arrays.asList(), Arrays.asList()),
	TURRET(Turret.class, RepeatingType.NONE, "Tourelle", Material.GOLD_NUGGET, 0, 1, 64, new McSound(), 465278045, false, 6, 1, Arrays.asList(), Arrays.asList()),
	AMMO_BOX(AmmoBox.class, RepeatingType.NONE, "Boite de munitions", Material.CAKE, 0, 1, 53, new McSound(), 1, false, 6, 23, Arrays.asList(), Arrays.asList()),
	...
	private WeaponType(Class<? extends Weapon> weapon, RepeatingType rt, String name, Material mat, int maxAmmo, int clipSize, int reloadTime, McSound sound, int price, boolean inMagicBox, int place, int rpm, List<String> others, List<Object> values)
	{
