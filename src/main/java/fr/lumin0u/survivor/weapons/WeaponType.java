...
public enum WeaponType
{
	...
	M16(M16.class, RepeatingType.BURSTS, "M16", Material.STONE_HOE, 300, 30, 124/*, new McSound("guns.m16a3", 40)*/, 2500, true, -1, 15, Arrays.asList("dmg", "range", "accuracy", "shots", "shotsDelay"), Arrays.asList(6.4D, 25.0D, 0.3D, 3, 3L)),
	SCARL(Scare.class, RepeatingType.AUTOMATIC, "SCAR-L", Material.DIAMOND_HOE, 400, 40, 52/*, new McSound("guns.scar", 60)*/, 3000, true, -1, 6, Arrays.asList("dmg", "range", "accuracy"), Arrays.asList(4.5D, 30.0D, 0.2D)),
