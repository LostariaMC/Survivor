...
public enum WeaponType
{
	...
	BUCHER_KNIFE(BucherKnife.class, RepeatingType.NONE, "Pelle Lourde", Material.NETHERITE_SHOVEL, 30, 1, 10, 300, true, -1, 20, Map.of("dmg", 18.9D)),
	...
	SCARL(Scare.class, RepeatingType.AUTOMATIC, "SCAR-L", Material.DIAMOND_HOE, 600, 40, 52/*, new McSound("guns.scar", 60)*/, 2200, true, -1, 6, Map.of("dmg", 4.2D, "range", 30.0D, "accuracy", PI / 160)),
	SKORPION(Skorpion.class, RepeatingType.AUTOMATIC, "Skorpion", Material.STICK, 320, 20, 45/*, new McSound("guns.scorpion", 50)*/, 2500, true, -1, 2, Map.of("dmg", 5.6D, "range", 20.0D, "accuracy", PI / 30)),
	MPLLF(MPLLF.class, RepeatingType.AUTOMATIC, "MPL-LF", Material.FEATHER, 700, 20, 13/*, new McSound("guns.mpllf", 35)*/, 1300, true, -1, 2, Map.of("dmg", 3.4D, "range", 25.0D, "accuracy", PI / 70, "kbMul", 1.4)),
	...
	MP5(MP5.class, RepeatingType.AUTOMATIC, "MP5", Material.GOLDEN_HOE, 700, 20, 26/*, new McSound("guns.mp5", 40)*/, 2500, true, -1, 3, Map.of("dmg", 3.3D, "range", 25.0D, "accuracy", PI / 60)),
	UMP45(UMP45.class, RepeatingType.AUTOMATIC, "UMP45", Material.IRON_HOE, 640, 40, 41/*, new McSound("guns.ump45", 40)*/, 1, true, -1, 2, Map.of("dmg", 2.3D, "range", 30.0D, "accuracy", PI / 120)),
	SPAS12(SPAS12.class, RepeatingType.SEMIAUTOMATIC, "SPAS-12", Material.GOLDEN_SHOVEL, 70, 1, 47/*, new McSound("guns.spas12", 80)*/, 1400, true, -1, 30, Map.of("dmg", 5.7D, "range", 7.5D, "accuracy", PI / 50, "shots", 8)),
	...
	DOUBLE_BARREL(DoubleBarrel.class, RepeatingType.SEMIAUTOMATIC, "Double Barrel", Material.DIAMOND_SHOVEL, 60, 2, 70/*, new McSound("guns.doublebarrel", 80)*/, 1, true, -1, 30, Map.of("dmg", 5.8D, "range", 20.0D, "accuracy", PI / 35, "shots", 7, "kbMul", 1.4)),
	DRAGUNOV(Dragunov.class, RepeatingType.SEMIAUTOMATIC, "Dragunov", Material.GOLD_INGOT, 110, 5, 98/*, new McSound("guns.sniper", 60)*/, 1, true, -1, 20, Map.of("dmg", 43.7D, "range", 300.0D, "accuracy", PI / 600)),
	MOSIN(MosinSniper.class, RepeatingType.SEMIAUTOMATIC, "Mosin", Material.GOLDEN_PICKAXE, 60, 1, 41/*, new McSound("guns.dragunov", 80)*/, 2500, true, -1, 20, Map.of("dmg", 137.0D, "range", 300.0D, "accuracy", PI / 600)),
	REVOLVER(Revolver.class, RepeatingType.SEMIAUTOMATIC, "Revolver", Material.DIAMOND_PICKAXE, 160, 6, 23/*, new McSound("guns.magnum", 50)*/, 1, true, -1, 15, Map.of("dmg", 17.4D, "range", 35.0D, "accuracy", PI / 300)),
	THOMPSON(Thompson.class, RepeatingType.AUTOMATIC, "Thompson", Material.NETHERITE_PICKAXE, 400, 25, 95/*, new McSound("guns.thompson", 70)*/, 3000, true, -1, 4, Map.of("dmg", 5.7D, "range", 50.0D, "accuracy", PI / 90)),
	TOMMY_GUN(TommyGun.class, RepeatingType.BURSTS, "Tommy Gun", Material.WOODEN_SHOVEL, 400, 25, 40/*, new McSound("guns.pm63", 35)*/, 500, true, -1, 17, Map.of("dmg", 3.5D, "range", 20.0D, "accuracy", PI / 60, "shots", 5, "shotsDelay", 1L)),
